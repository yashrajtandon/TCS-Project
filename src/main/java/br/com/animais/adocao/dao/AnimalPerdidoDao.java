 ...
 */
public class AnimalPerdidoDao implements AnimalDaoInterface<Animal> {
	...
	public List<Animal> buscarAnimaisOngPerdido(Long id) {
		EntityManager em = JPAUtil.getEntityManager();
		TypedQuery<Animal> query = em.createQuery("from Animal a where a.ong.id = :id and a.status = 'perdido'",
				Animal.class);
		query.setParameter("id", id);
	...
	public List<Animal> buscarAnimaisPessoaPerdido(Long id) {
		EntityManager em = JPAUtil.getEntityManager();
		TypedQuery<Animal> query = em.createQuery("from Animal a where a.pessoa.id = :id and a.status = 'perdido'",
				Animal.class);
		query.setParameter("id", id);
	...
	public List<Animal> buscarAnimalPorTipo(String tipo) {
		EntityManager em = JPAUtil.getEntityManager();
		TypedQuery<Animal> query = em.createQuery("from Animal a where a.tipoAnimal = :tipo and a.status = 'perdido'",
				Animal.class);
	...
	public List<Animal> buscarAnimaisTodos(String tipo, String raca, String estado) {
		...
		TypedQuery<Animal> query = em.createQuery(
				"from Animal a where a.tipoAnimal = :tipo and a.raca.nome = :raca and a.estado = :estado and a.status = 'perdido'",
				Animal.class);
		query.setParameter("tipo", tipo);
	...
	public List<Animal> buscarAnimaisTipoRaca(String tipo, String raca) {
		EntityManager em = JPAUtil.getEntityManager();
		TypedQuery<Animal> query = em.createQuery(
				"from Animal a where a.tipoAnimal = :tipo and a.raca.nome = :raca and a.status = 'perdido'",
				Animal.class);
		query.setParameter("tipo", tipo);
		query.setParameter("raca", raca);
	...
	public List<Animal> buscarAnimaisTipoEstado(String tipo, String estado) {
		EntityManager em = JPAUtil.getEntityManager();
		TypedQuery<Animal> query = em.createQuery(
				"from Animal a where a.tipoAnimal = :tipo and a.estado = :estado and a.status = 'perdido'",
				Animal.class);
		query.setParameter("tipo", tipo);
		query.setParameter("estado", estado);
	...
	public List<Animal> buscarAnimaisRacaEstado(String raca, String estado) {
		EntityManager em = JPAUtil.getEntityManager();
		TypedQuery<Animal> query = em.createQuery(
				"from Animal a where a.raca.nome = :raca and a.estado = :estado and a.status = 'perdido'",
				Animal.class);
		query.setParameter("raca", raca);
		query.setParameter("estado", estado);
	...
	public List<Animal> buscarAnimaisSomenteEstado(String estado) {
		EntityManager em = JPAUtil.getEntityManager();
		TypedQuery<Animal> query = em.createQuery("from Animal a where a.estado = :estado and a.status = 'perdido'",
				Animal.class);
		query.setParameter("estado", estado);
